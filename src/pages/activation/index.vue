<template>
  <div class="common-page activation-page">
    <div class="common-head">
      <h1 class="common-title">{{ t('activation.title') }}</h1>
    </div>
...
.activation-page {
  ...
  overflow: hidden;
  margin: 0;
  padding: calc(2 * var(--theme-home-band-height, 50px) - 8px) 20px 56px;
  background: #fff;
...
@media (max-width: 890px) {
  .activation-page {
    padding: calc(2 * var(--theme-home-band-height, 30px) + 8px) 10px 32px;
